...
pub trait PetApi: Send + Sync {
    ...
    async fn pets_explode_post<'page_explode>(&self, page_explode: Option<models::PetsExplodePostPageExplodeParameter>) -> Result<Vec<models::Pet>, Error<PetsExplodePostError>>;
