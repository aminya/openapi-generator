...
pub fn pets_explode_post(configuration: &configuration::Configuration, page_explode: Option<models::FooPetsExplodePostPageExplodeParameter>) -> Result<Vec<models::FooPet>, Error<PetsExplodePostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
