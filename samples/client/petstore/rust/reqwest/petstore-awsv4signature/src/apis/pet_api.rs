...
pub fn pets_explode_post(configuration: &configuration::Configuration, page_explode: Option<models::PetsExplodePostPageExplodeParameter>) -> Result<Vec<models::Pet>, Error<PetsExplodePostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
